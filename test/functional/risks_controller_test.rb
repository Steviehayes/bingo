...
class RisksControllerTest < ActionController::TestCase
  ...
  test "should create risk" do
    assert_difference('Risk.count') do
      post :create, risk: { description: @risk.description, impacts: @risk.impacts, title: @risk.title }
    end
  ...
  test "should update risk" do
    put :update, id: @risk, risk: { description: @risk.description, impacts: @risk.impacts, title: @risk.title }
    assert_redirected_to risk_path(assigns(:risk))
  end
